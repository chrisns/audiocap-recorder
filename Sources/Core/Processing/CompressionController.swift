...
private final class PassthroughCompressionEngine: CompressionEngineProtocol {
    ...
    func getCompressionProgress() -> CompressionProgress { .init(bytesProcessed: 0, estimatedTotalBytes: 0, compressionRatio: 1.0, encodingSpeedMBps: 0, timeRemaining: nil, cpuUsagePercent: 0, elapsedSeconds: 0) }
}
