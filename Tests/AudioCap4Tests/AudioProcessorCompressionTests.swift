...
private final class StubEngine: CompressionEngineProtocol {
    ...
    func getCompressionProgress() -> CompressionProgress { .init(bytesProcessed: 0, estimatedTotalBytes: 0, compressionRatio: 0, encodingSpeedMBps: 0, timeRemaining: nil, cpuUsagePercent: 0) }
}
